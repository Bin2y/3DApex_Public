...
public class FPSMovement : MonoBehaviour
{
    ...
    {
        return !Mathf.Approximately(_input.move.normalized.magnitude, 0f);
    }
    ...
    private void UpdateMovementState()
    {
        ...
        if (MovementState == FPSMovementState.Sprinting
            && _input.move.y > 0f && Mathf.Approximately(_input.move.x, 0f))
        {
            return;
        }
    ...
    {
        var normInput = _input.move.normalized;
    ...
    {
        var animatorVelocity = _input.move;
    ...
    public void OnSprint(InputAction.CallbackContext context)
    {
        ...
        bool enableSprint = context.performed && CanSprint();
        if (enableSprint)
        {
